...
import LogoImage from '../src/assets/logopd.png'

const TWITTER_HANDLE = 'CryptonikasDao';
const TWITTER_LINK = `https://twitter.com/${TWITTER_HANDLE}`;
const OPENSEA_LINK = 'https://testnets.opensea.io/assets?search[query]=0x078Dd8D81DEF4D61Fd2d8EbFBA5f2300B2773a58';
const TOTAL_MINT_COUNT = 30;

// I moved the contract address to the top for easy access.
const CONTRACT_ADDRESS = "0x2B9b13EABb4a04EF9D53e9fe2F5a63c1bF000309";
  ...
  const askContractToMintNft = async () => {
    ...
    try {
      ...
      if (ethereum) {
        ...
        console.log("Mining...please wait.Te dije que esperes!")
        await nftTxn.wait();
        setIsLoading(false);
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <p className="header gradient-text">Rachel NFT Collection</p>
